...
def visual_stage3(image_path, point_list, stage_list, save_path, patch_size=224,orignal_annotation=[]):
    ...
    for cnt, (x, y) in enumerate(point_list):  # x is for width, y is for height
...
for image_name in data_dict:
    ...
    visual_stage3(
        ...
        point_list=data['stage_sample'],
        stage_list=data['stage_list'],
        save_path= save_path,
        orignal_annotation= data['ridge']["vessel_abnormal_coordinate"])